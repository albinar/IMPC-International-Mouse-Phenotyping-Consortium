...
{
  centre <- readline(prompt = "Enter the centre name (Sanger/TCP/CIPHE/BCM/JAX/GMC/UCD/CCP):")
  centre <- tolower(centre)
  if(centre == "sanger" | centre == "tcp" | centre == "ciphe" | centre == "bcm" | centre == "jax" | centre == "gmc" | centre == "ucd" | centre == "ccp")
  {
    return(centre)
  }else{
...
compensateIMPC <- function(ff, fname, fpath, centre, panel.no, assayDate){
  centre <- tolower(centre)
  ...
  if (centre == "bcm"){
    ...
    ## temporarily commenting this part
    ...
    # 
    # file.names.202009A <- c("Panel_A_EXPT_Panel_A_AEGP_91_C8C08032.fcs", "Panel_A_EXPT_Panel_A_AEGQ_110_C4C04028.fcs",
    #                         "Panel_A_EXPT_Panel_A_AEGQ_111_C5C05029.fcs", "Panel_A_EXPT_Panel_A_AEGT_101_C6C06030.fcs",
    #                         "Panel_A_EXPT_Panel_A_AEGT_104_C7C07031.fcs", "Panel_A_EXPT_Panel_A_AEGV_75_C2C02026.fcs",
    #                         "Panel_A_EXPT_Panel_A_AEGV_92_C3C03027.fcs", "Panel_A_EXPT_Panel_A_AEHJ_102_C1C01025.fcs",
    #                         "Panel_A_ADPT_423_C9C09037.fcs", "Panel_A_ADPT_431_C10C10038.fcs", "Panel_A_ADYC_172_C11C11040.fcs",
    #                         "Panel_A_AEIA_123_C5C05033.fcs", "Panel_A_AEIA_124_C6C06034.fcs", "Panel_A_AEJO_106_C1C01029.fcs", 
    #                         "Panel_A_AEJO_109_C2C02030.fcs", "Panel_A_AEJQ_87_C3C03031.fcs", "Panel_A_AEJQ_92_C12C12039.fcs", 
    #                         "Panel_A_AEJQ_95_C4C04032.fcs", "Panel_A_AEJX_90_C7C07035.fcs", "Panel_A_AEJX_91_C8C08036.fcs",
    #                         "Panel_A_ADYC_165_C9C09035.fcs", "Panel_A_ADYC_167_C7C07033.fcs", "Panel_A_ADYC_170_C8C08034.fcs",
    #                         "Panel_A_ADYC_175_C10C10036.fcs", "Panel_A_AEIA_119_C1C01027.fcs", "Panel_A_AEIA_128_C2C02028.fcs",
    #                         "Panel_A_AEIY_78_C6C06032.fcs", "Panel_A_AEJQ_83_C3C03029.fcs", "Panel_A_AEJQ_84_C4C04030.fcs",
    #                         "Panel_A_AEJQ_90_C5C05031.fcs", "Panel_A_AEHN_127_C9C09040.fcs", "Panel_A_AEHN_129_C10C10044.fcs",
    #                         "Panel_A_AEHP_108_C5C05036.fcs", "Panel_A_AEHP_117_C6C06037.fcs", "Panel_A_AEHP_118_C7C07038.fcs", 
    #                         "Panel_A_AEIF_133_C1C01032.fcs", "Panel_A_AEIF_135_C2C02033.fcs", "Panel_A_AEJO_113_C3C03034.fcs", 
    #                         "Panel_A_AEJO_114_C4C04035.fcs", "Panel_A_AEJX_101_C8C08039.fcs", "Panel_A_ADPT_428_C12C12039.fcs",
    #                         "Panel_A_ADRX_442_C11C11040.fcs", "Panel_A_AEHP_114_C3C03031.fcs", "Panel_A_AEHP_123_C4C04032.fcs",
    #                         "Panel_A_AEIB_67_C8C08036.fcs", "Panel_A_AEIB_68_C9C09037.fcs", "Panel_A_AEJL_110_C10C10038.fcs",
    #                         "Panel_A_AEJM_112_C1C01029.fcs", "Panel_A_AEJM_120_C2C02030.fcs", "Panel_A_AELQ_72_C5C05033.fcs",
    #                         "Panel_A_AELQ_86_C6C06034.fcs", "Panel_A_AELQ_94_C7C07035.fcs", "Panel_A_AEHN_133_C3C03033.fcs",
    #                         "Panel_A_AEHN_135_C4C04034.fcs", "Panel_A_AEHP_120_C1C01031.fcs", "Panel_A_AEHP_128_C2C02032.fcs",
    #                         "Panel_A_AEIA_141_C5C05035.fcs", "Panel_A_AEIA_147_C6C06036.fcs", "Panel_A_B6NC_3142_C7C07037.fcs",
    #                         "Panel_A_B6NC_3143_C8C08038.fcs", "Panel_A_B6NC_3144_C9C09039.fcs", "Panel_A_B6NC_3147_C10C10040.fcs",
    #                         "Panel_A_B6NC_3148_C11C11044.fcs", "FMO_PANEL_A_FMO_Panel_A_CD161_APC_D4D04006.fcs", 
    #                         "FMO_PANEL_A_FMO_Panel_A_CD25_PECY7_D3D03005.fcs", "FMO_PANEL_A_FMO_Panel_A_CD44_PE_D2D02004.fcs",
    #                         "FMO_PANEL_A_FMO_Panel_A_CD5_BV421_D1D01003.fcs", "FMO_PANEL_A_FMO_Panel_A_CD62L_APCCY7_D6D06008.fcs",
    #                         "FMO_PANEL_A_FMO_Panel_A_CD8a_PECF594_D5D05007.fcs", "FMO_PANEL_A_FMO_Panel_A_CD161_APC_D4D04006.fcs",
    #                         "FMO_PANEL_A_FMO_Panel_A_CD25_PECY7_D3D03005.fcs", "FMO_PANEL_A_FMO_Panel_A_CD44_PE_D2D02004.fcs",
    #                         "FMO_PANEL_A_FMO_Panel_A_CD5_BV421_D1D01003.fcs")
    ...
    #   rownames(SPILL.matrix) <- colnames(SPILL.matrix)
    # }
    # if(fname %in% file.names.202009A){
    #     SPILL.matrix <- read.csv("/home/rstudio/data/IMPC/TCP/Tcp_extra/Compensations/Originals/Compensation_Matrix_2020-09_PANEL_A.csv", check.names = F)[,-1]
    #   #   #SPILL.matrix <- read.csv("/mnt/f/FCS data/IMPC/IMPC_2016_Pilot_Data/TCP/Tcp_extra/Compensations/Originals/COMPENSATION_CONTROL_2015-09-09_PanelA.csv", check.names = F)[,-1]
    # }else{
    ...
    #   }
    # }
    if(length(grep("2020-09-", assayDate))==1){
      SPILL.matrix <- read.csv("/home/rstudio/data/IMPC/TCP/Tcp_extra/Compensations/Originals/Compensation_Matrix_2020-09_PANEL_A.csv", check.names = F)[,-1]
      #   #SPILL.matrix <- read.csv("/mnt/f/FCS data/IMPC/IMPC_2016_Pilot_Data/TCP/Tcp_extra/Compensations/Originals/COMPENSATION_CONTROL_2015-09-09_PanelA.csv", check.names = F)[,-1]
    }else{
      if(det(ff@description$SPILL) == 1){
    ...
    if(length(ff@description$SPILL) > 0){
      ff <-compensate(ff, ff@description$SPILL)
      ...
      # colnames(SPILL.matrix) <- colnames(ff@description$SPILL)
      # ff <- compensate(ff, SPILL.matrix)
    }else{
      ff <-compensate(ff, ff@description$`$SPILLOVER`)
      # compMatrix <- dir(fpath, full.names = T, recursive = F, pattern = ".*csv")
      # SPILL.matrix <- read.csv(compMatrix, stringsAsFactors = F, check.names = F)[,-1]
      # colnames(SPILL.matrix) <- colnames(ff@description$`$SPILLOVER`)
      # ff <- compensate(ff, SPILL.matrix)
    }
