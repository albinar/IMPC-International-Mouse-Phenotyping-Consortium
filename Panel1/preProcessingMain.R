...
#centreInfo <- rbind(centreInfo, c("Sanger", "L[0-9]+"), c("TCP", "[[:alnum:]]{4}[_][0-9]+"), c("CIPHE", "NA"), c("BCM", "[:digit:]{5,}"), c("Jax","[:digit:]{4,}"),  c("GMC","[:digit:]{8,}"), c("UCD", "[[:alnum:]]{6,}[_][:digit:]{2,}"), c("CCP", "[[:alnum:]]{3}[-][[:alnum:]]{5}"))
centreInfo <- rbind(centreInfo, c("Sanger", "L[0-9]+"), c("TCP", "[[:alnum:]]{4}[_][0-9]+"), c("CIPHE", "NA"), c("BCM", "[:digit:]{5,}"), c("Jax","[:digit:]{4,}"),  c("GMC","[:digit:]{8,}"), c("UCD", "[^.fcs]+"),  c("CCP", "[_][[:alnum:]]{3}[-][[:alnum:]]{5}")) ## UCDavis has inconsistency in the way they have named the files. So for Barcodes, I am grabbing everything before the .fcs and later in the preProcessingFunc.R I will be removing the _PANEL_A or _PANEL_B suffix for Barcodes
...
if(centre == "tcp"){
  ...
  inPath3 <- "/home/rstudio/data/IMPC/TCP/TCP_210105/UPLOAD_DUMP"
  inCSVpath3 <- "/home/rstudio/data/IMPC/TCP/TCP_210105/Report-flowCytometryMetadata-limsReport.csv"
  inPath4 <- "/home/rstudio/data/IMPC/TCP/TCP_210105_Pain/UPLOAD_DUMP"
  inCSVpath4 <- "/home/rstudio/data/IMPC/TCP/TCP_210105/Report-flowCytometryMetadata-limsReport.csv"
  inPath5 <- "/home/rstudio/data/IMPC/TCP/TCP_211210/UPLOAD_DUMP"
  inCSVpath5 <- "/home/rstudio/data/IMPC/TCP/TCP_211210/flowCytometryMetadata.csv"
  
  
  inputPath <- list(inPath1, inPath2, inPath3, inPath4, inPath5)
  inputCSV <- list(inCSVpath1, inCSVpath2, inCSVpath3, inCSVpath4, inCSVpath5)
  if(panel == 1){
  ...
  inCSVpath1 <- "/home/rstudio/data/IMPC/CIPHE/IMPC_2014_Raw_codeICS-2.csv"
  inCSVpath2 <- "/home/rstudio/data/IMPC/CIPHE/IMPC_2015_Raw_codeICSV3.csv"
  inCSVpath3 <- "/home/rstudio/data/IMPC/CIPHE/IMPC_2016_Raw.csv"
  inCSVpath4 <- "/home/rstudio/data/IMPC/CIPHE/IMPC_2017_Raw.csv"
  inCSVpath5 <- "/home/rstudio/data/IMPC/CIPHE/IMPC_2018_Raw.csv"
  inCSVpath6 <- "/home/rstudio/data/IMPC/CIPHE/IMPC_2019_Raw.csv"
  inCSVpath7 <- "/home/rstudio/data/IMPC/CIPHE/IMPC_2020_Raw.csv"
  inputCSV <- list(inCSVpath1, inCSVpath2, inCSVpath3, inCSVpath4, inCSVpath5, inCSVpath6, inCSVpath7)
  #inputCSV <- list(inCSVpath4)
  if(panel == 1){
    inPath1 <- "/home/rstudio/data/IMPC/CIPHE/CIPHE/IMPC_CIPHE_2014/IMPC1"
    inPath2 <- "/home/rstudio/data/IMPC/CIPHE/CIPHE/IMPC_CIPHE_2015/IMPC1"
    inPath3 <- "/home/rstudio/data/IMPC/CIPHE/CIPHE/IMPC_2016/IMPC1"
    inPath4 <- "/home/rstudio/data/IMPC/CIPHE/CIPHE/IMPC_2017/IMPC1"
    inPath5 <- "/home/rstudio/data/IMPC/CIPHE/CIPHE/IMPC_2018/IMPC1"
    inPath6 <- "/home/rstudio/data/IMPC/CIPHE/CIPHE/IMPC_2019/IMPC1"
    inPath7 <- "/home/rstudio/data/IMPC/CIPHE/CIPHE/IMPC_2020/IMPC1"
    inputPath <- list(inPath1, inPath2, inPath3, inPath4, inPath5, inPath6, inPath7)
    #inputPath <- list(inPath4)
    outputPath <- "/home/rstudio/results/IMPC/CIPHE/Panel1/"
  }else if(panel == 2){
    inPath1 <- "/home/rstudio/data/IMPC/CIPHE/CIPHE/IMPC_CIPHE_2014/IMPC2"
    inPath2 <- "/home/rstudio/data/IMPC/CIPHE/CIPHE/IMPC_CIPHE_2015/IMPC2"
    inPath3 <- "/home/rstudio/data/IMPC/CIPHE/CIPHE/IMPC_2016/IMPC2"
    inPath4 <- "/home/rstudio/data/IMPC/CIPHE/CIPHE/IMPC_2017/IMPC2"
    inPath5 <- "/home/rstudio/data/IMPC/CIPHE/CIPHE/IMPC_2018/IMPC2"
    inPath6 <- "/home/rstudio/data/IMPC/CIPHE/CIPHE/IMPC_2019/IMPC2"
    inPath7 <- "/home/rstudio/data/IMPC/CIPHE/CIPHE/IMPC_2020/IMPC2"
    inputPath <- list(inPath1, inPath2, inPath3, inPath4, inPath5, inPath6, inPath7)
    
    outputPath <- "/home/rstudio/results/IMPC/CIPHE/Panel2/"
  }
}else if(centre == "bcm"){
  ...
  inPath2 <- "/home/rstudio/data/IMPC/JAX/2017-05-12/JAXKOMP_Tmem 5304 Jan'14-May'14"
  inPath3 <- "/home/rstudio/data/IMPC/JAX/2017-05-12/JAXKOMP_Tmem 5304 May'14-Dec'15"
  inPath4 <- "/home/rstudio/data/IMPC/JAX/2021-04-20/KOMP before Dec 13"
  inPath5 <- "/home/rstudio/data/IMPC/JAX/2021-04-20/KOMP new panel Dec'13"
  inPath6 <- "/home/rstudio/data/IMPC/JAX/PKG-JAX"
  
  
  inputPath <- list(inPath1, inPath2, inPath3, inPath4, inPath5, inPath6)
  
  inCSVpath1 <- "/home/rstudio/data/IMPC/JAX/Jax_2017-03-29/Jax_metadata_20170331.csv"
  inCSVpath2 <- "/home/rstudio/data/IMPC/JAX/2017-05-12/JAXKOMP_Tmem 5304 Jan'14-May'14/Animal_data_5304_Jan14-Apr14.csv"
  inCSVpath3 <- "/home/rstudio/data/IMPC/JAX/2017-05-12/JAXKOMP_Tmem 5304 May'14-Dec'15/Animal_data_5304_May14-Dec15.csv"
  inCSVpath4 <- "/home/rstudio/data/IMPC/JAX/2021-04-20/Metadata/Updated IMPC database pre-Dec'13-Combined.csv"
  inCSVpath5 <- "/home/rstudio/data/IMPC/JAX/2021-04-20/Metadata/KOMP summary_v14-0109.csv"
  inCSVpath6 <- "/home/rstudio/data/IMPC/JAX/PKG-JAX/IMPC_database_16-0602-Metadata.csv"
  
  
  inputCSV <- list(inCSVpath1, inCSVpath2, inCSVpath3, inCSVpath4, inCSVpath5, inCSVpath6)
  if(panel == 1){
  ...
  if(panel == 1){
    inPath1 <- "/home/rstudio/data/IMPC/UCD/UCDavis-Complete_Data/FCS_Files/Panel_A"
    outputPath <- "/home/rstudio/results/IMPC/UCD/Panel1/"
  }else if(panel == 2){
    inPath1 <- "/home/rstudio/data/IMPC/UCD/UCDavis-Complete_Data/FCS_Files/Panel_B"
    outputPath <- "/home/rstudio/results/IMPC/UCD/Panel2/"
    
  }
  
  inCSVpath1 <- "/home/rstudio/data/IMPC/UCD/UCDavis-Complete_Data/Combined_Metadata_2020.csv"
  ...
  if(panel == 1){
    inPath1 <- "/home/rstudio/data/IMPC/CCP/CCPftp/Panel_A"
    outputPath <- "/home/rstudio/results/IMPC/CCP/Panel1/"
    inCSVpath1 <- "/home/rstudio/data/IMPC/CCP/CCPftp/Metadata/CCP_metadata_Panel_A.csv"
    
  }else if(panel == 2){
    inPath1 <- "/home/rstudio/data/IMPC/CCP/CCPftp/Panel_B"
    outputPath <- "/home/rstudio/results/IMPC/CCP/Panel2/"
    inCSVpath1 <- "/home/rstudio/data/IMPC/CCP/CCPftp/Metadata/CCP_metadata_Panel_B.csv"
...
#panel1.Names <- c("Panel1", "IMPC1", "PANEL_A", "PANEL A_REPEATEXPT_Panel_A", "Panel_A_EXPT_Panel_A", "EXPT_Panel_A", "Tmem panel")
panel1.Names <- c("Panel1", "IMPC1", "PANEL_A", "_Panel_A", "Panel_A", "Tmem panel")

#panel2.Names <- c("Panel2", "IMPC2", "PANEL_B", "Panel_B_EXPT_Panel_B", "EXPT_Panel_B", "APC panel")
panel2.Names <- c("Panel2", "IMPC2", "PANEL_B", "_Panel_B", "Panel_B", "APC panel")
...
if(centre == "tcp" | centre == "jax"){
  ...
  print(paste0("There are in total ", nrow(store.allFCS), " Panel 1 & 2 files for analysis."))
  print(paste0("There are in total ", nrow(store.allFCS.panel1), " Panel 1 files for analysis."))
  print(paste0("There are in total ", nrow(store.allFCS.panel2), " Panel 2 files for analysis."))
  print(paste0("There are in total ", nrow(store.allFMO), " FMOs for Panels 1 & 2."))
  print(paste0("There are in total ", nrow(store.allFMO.panel1), " FMOs for Panel 1."))
  print(paste0("There are in total ", nrow(store.allFMO.panel2), " FMOs for Panel 2."))
...
}else if (centre == "sanger" | centre == "ciphe" | centre == "bcm" | centre == "gmc" | centre == "ucd" | centre == "ccp"){
  ## Writing the Summary of the Pre-Processing output in a text file
  print("Printing the Summary of the Pre-Processing Output: ")
  suppressWarnings(dir.create (paste0(outputPath,"Results/")))
  sink(file = paste0(outputPath,"Results/preProcessing-Summary.txt"), split = TRUE)
...
store.allFCS <- store.allFCS.Original[3187:3196,]
